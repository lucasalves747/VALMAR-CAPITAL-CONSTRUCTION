...
const values = [
  {
    ...
    description: "Nossa equipe irá analisar sua inscrição nas próximas 24-48 horas. Você receberá um e-mail confirmando o recebimento da sua inscrição.",
  },
  {
    icon: "2",
    title: "Agendamento de Entrevista",
    description: "Se seu perfil for pré-aprovado, entraremos em contato para agendar uma entrevista. Esta é uma oportunidade para nos conhecermos melhor e entendermos seus objetivos com a mentoria.",
  },
  {
    icon: "3",
    title: "Resultado Final",
    description: "Após a entrevista, você receberá o resultado final do processo seletivo. Se aprovado, enviaremos as instruções para pagamento e garantia da sua vaga.",
  },
  {
    icon: "4",
          ...
          {values.map((value, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-10 h-10 sm:w-12 sm:h-12 sm:mb-6 mx-auto sm:mx-0 flex items-center justify-center rounded-full bg-gold text-white font-bold">
                  {value.icon}
                </div>
